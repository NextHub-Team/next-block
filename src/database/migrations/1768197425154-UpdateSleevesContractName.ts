...
export class UpdateSleevesContractName1768197425154
  implements MigrationInterface
{
  name = 'UpdateSleevesContractName1768197425154';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "sleeves" RENAME COLUMN "ContractName" TO "contractName"`,
    );
    await queryRunner.query(
