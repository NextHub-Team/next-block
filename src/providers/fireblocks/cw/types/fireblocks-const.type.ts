...
export const FIREBLOCKS_REQUEST_TIMEOUT_MS = 30000;

export const FIREBLOCKS_MAX_RETRIES = 3;

export const FIREBLOCKS_CIRCUIT_BREAKER_FAILURE_THRESHOLD = 5;

export const FIREBLOCKS_CIRCUIT_BREAKER_RESET_TIMEOUT_MS = 30000;

export const FIREBLOCKS_CIRCUIT_BREAKER_HALF_OPEN_SAMPLE = 1;

export const FIREBLOCKS_RATE_LIMIT_TOKENS_PER_INTERVAL = 10;

export const FIREBLOCKS_RATE_LIMIT_INTERVAL_MS = 1000;

export const FIREBLOCKS_DEBUG_LOGGING = false;

export const FIREBLOCKS_VAULT_NAME_PREFIX = 'user';
